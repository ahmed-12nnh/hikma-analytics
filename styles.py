...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    /* إخفاء نافيجيشن الصفحات الافتراضي */
    ...
    .report-card-title { color: #FFD700; font-weight: 600; margin-bottom: 6px; }
    ...
    [data-testid="stSidebar"] .stButton > button { background: linear-gradient(135deg, rgba(26, 45, 74, 0.9), rgba(13, 31, 60, 0.95)) !important; color: #FFD700 !important; border: 1px solid rgba(255, 215, 0, 0.3) !important; font-weight: 600 !important; border-radius: 8px !important; }
    ...
    div[role="radiogroup"] label {
        background: rgba(0, 31, 63, 0.8) !important; border: 1px solid rgba(255, 215, 0, 0.3) !important; padding: 15px 25px !important; border-radius: 12px !important;
        cursor: pointer !important; transition: all 0.3s !important; text-align: center !important; flex: 1 !important; min-width: 160px !important;
        color: white !important; font-weight: 600 !important;
    }
    div[role="radiogroup"] label:hover {
        background: rgba(255, 215, 0, 0.1) !important; border-color: #FFD700 !important; transform: translateY(-5px) scale(1.02) !important;
    }
    ...
    /* زر المعالجة */
    .stButton > button {
        background: linear-gradient(135deg, #FFD700 0%, #DAA520 50%, #FFD700 100%) !important; background-size: 200% auto !important; color: #001f3f !important; font-family: 'Tajawal', sans-serif !important; font-weight: 900 !important; font-size: 1.3rem !important;
        border-radius: 15px !important; width: 100% !important; padding: 18px 40px !important; border: none !important; box-shadow: 0 8px 30px rgba(218, 165, 32, 0.4) !important; transition: all 0.4s !important; animation: buttonPulse 2s infinite !important;
    }
    ...
    .stSuccess { background: rgba(34, 197, 94, 0.15) !important; border-color: rgba(34, 197, 94, 0.5) !important; }
    .stWarning { background: rgba(255, 193, 7, 0.15) !important; border-color: rgba(255, 193, 7, 0.5) !important; }
    .stError { background: rgba(220, 53, 69, 0.15) !important; border-color: rgba(220, 53, 69, 0.5) !important; }

    /* زر التحميل */
    .stDownloadButton > button { background: linear-gradient(135deg, #6366f1, #8b5cf6) !important; color: white !important; font-size: 1.1rem !important; font-weight: 700 !important; padding: 15px 40px !important; border-radius: 12px !important; border: none !important; box-shadow: 0 8px 25px rgba(99, 102, 241, 0.4) !important; }
