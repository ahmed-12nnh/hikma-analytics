...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    /* إخفاء زر الشريط الجانبي الافتراضي */
    ...
    .sidebar-title { color: #FFD700; font-size: 1.2rem; font-weight: 700; }
    ...
    .report-title { color: #FFD700; font-size: 0.95rem; font-weight: 600; margin-bottom: 8px; }
    .report-meta { color: rgba(255, 255, 255, 0.6); font-size: 0.75rem; margin-bottom: 5px; }
    .report-time { color: rgba(255, 255, 255, 0.4); font-size: 0.7rem; }
    ...
    .empty-icon { font-size: 3rem; margin-bottom: 15px; opacity: 0.6; }
    .empty-text { color: rgba(255, 255, 255, 0.6); font-size: 1rem; margin-bottom: 8px; }
    .empty-hint { color: rgba(255, 255, 255, 0.4); font-size: 0.85rem; }
    ...
    .sidebar-footer span { color: rgba(255, 215, 0, 0.5); font-size: 0.8rem; }
    ...
    [data-testid="stFileUploader"]:hover { border-color: #FFD700 !important; }
    ...
    .footer-org { color: #FFD700; font-size: 1.1rem; font-weight: 700; margin-bottom: 8px; }
    .footer-unit { color: rgba(255, 255, 255, 0.8); font-size: 1rem; margin-bottom: 15px; }
    .footer-divider { width: 100px; height: 1px; background: rgba(255, 215, 0, 0.3); margin: 15px auto; }
...
<style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    table tr:hover td { background: rgba(197, 160, 89, 0.1); }
    ...
    .signature-org { color: var(--navy); font-size: 1.2em; font-weight: 700; margin: 10px 0 5px 0; }
    .signature-unit { color: var(--gold); font-size: 1.1em; font-weight: 600; margin: 0; }
...
<style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .container { max-width: 1200px; margin: 20px auto; padding: 25px; }
    ...
    .dashboard-header h1, header h1 { color: white; font-size: 2.2em; font-weight: 800; }
    .dashboard-header p, header p { color: var(--accent); font-size: 1.1em; }
    ...
    .metric-value { font-size: 2.8em; font-weight: 800; color: var(--accent); }
    .metric-label { color: var(--text-muted); font-size: 0.95em; }
    ...
    .progress-label { display: flex; justify-content: space-between; margin-bottom: 8px; color: var(--text-muted); }
    ...
    .alert-box { padding: 20px; border-radius: 12px; margin: 15px 0; }
    .alert-box.success { background: rgba(34, 197, 94, 0.15); border: 1px solid rgba(34, 197, 94, 0.3); color: #22c55e; }
    .alert-box.warning { background: rgba(245, 158, 11, 0.15); border: 1px solid rgba(245, 158, 11, 0.3); color: #f59e0b; }
    .alert-box.info { background: rgba(59, 130, 246, 0.15); border: 1px solid rgba(59, 130, 246, 0.3); color: #3b82f6; }
    
    table { width: 100%; border-collapse: collapse; margin: 20px 0; }
    table th { background: var(--primary-dark); color: white; padding: 15px; }
    table td { padding: 15px; border-bottom: 1px solid rgba(255,255,255,0.1); }
    ...
    .signature-line { width: 80px; height: 3px; background: linear-gradient(90deg, transparent, var(--accent), transparent); margin: 15px auto; }
    .signature-icon { font-size: 2.5em; margin: 15px 0; }
...
<style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    header h1 { font-size: 2.2em; font-weight: 800; margin-bottom: 10px; }
    ...
    .stat-card .stat-value, .stat-card .value { font-size: 2.5em; font-weight: 800; color: var(--primary); }
    .stat-card .stat-label { color: #666; font-size: 0.95em; }
    ...
    .bar-label { display: flex; justify-content: space-between; margin-bottom: 8px; font-weight: 600; }
    .bar-container { height: 12px; background: #e0e0e0; border-radius: 10px; overflow: hidden; }
...
<style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .main-title { font-size: 3.5em; color: var(--white); margin-bottom: 15px; }
    .sub-title { font-size: 1.8em; color: var(--gold); font-weight: 300; }
    ...
    .header-title h2 { color: var(--gold); font-size: 2em; font-weight: 800; }
    .header-logo { color: var(--white); font-weight: bold; }
    ...
    h3 { color: var(--blue); font-size: 1.5em; margin-bottom: 15px; border-bottom: 2px dashed #ccc; padding-bottom: 10px; }
    ...
    .nav-btn:hover { background: var(--gold); color: var(--navy); transform: scale(1.1); }
...
<style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .brand { font-size: 1.5em; font-weight: 800; color: var(--navy); }
    
    h1 { font-size: 2.8em; font-weight: 900; line-height: 1.2; margin-bottom: 15px; color: var(--black); }
    ...
    .metric-val { font-size: 2.8em; font-weight: 800; color: var(--navy); }
    .metric-lbl { font-size: 1em; color: var(--gray); text-transform: uppercase; }
    ...
    .signature-line { width: 60px; height: 3px; background: linear-gradient(90deg, transparent, var(--gold), transparent); margin: 15px auto; }
    ...
    footer { text-align: center; padding: 20px; color: #999; font-size: 0.85em; border-top: 1px solid #eee; margin-top: 40px; }
</style>
"""
